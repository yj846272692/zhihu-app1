<template>
	<div>
		<div class="recommend" v-for="(item, index) in followList" :key="index">
			<div class="item">
				...
				<div v-if="!flags[index]">
					...
					<div class="content" v-if="item.target.thumbnail">
						...
						<div class="text">
							<span class="richText">{{ item.target.author.name }}: <span v-html="item.target.excerpt"></span></span>
					...
					<div class="content" v-else>
						<div class="text">
							<span class="richText-simple">{{ item.target.author.name }}:<span v-html="item.target.excerpt"></span></span>
							<button class="Button readMore Button--plain" @click="change(index)">
								阅读全文
								<span style="display: inline-flex; align-items: center;">
									​
